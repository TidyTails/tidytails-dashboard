# Hourly Task Rotation System

## Business Areas (Rotate Through)
...
- [ ] Case studies from jobs

### 🏠 SHEDS (TuffShed/WoodMaster)
- [ ] New Marketplace ad copy
- [ ] Instagram content ideas
- [ ] Promo-specific ads (current deals)
- [ ] Competitor shed dealers research
- [ ] Financing angle variations
- [ ] Seasonal hooks (spring, tax refund, etc.)

### 🤖 CONSULTING (AI Marketing)
- [ ] Package refinement
...
1. **Every hour, pick from a DIFFERENT area** than the last task
2. **Prioritize by impact:** Lead gen > content > systems
3. **After each task:**
   - Update `dashboard/index.html` (Franklin's Work section)
   - Update `docs/FRANKLINS_WORK_LOG.md`
   - Push to GitHub
4. **Track completion** by checking off items above
5. **If stuck:** Research competitors or create more ad variations (always valuable)

---

## Today's Rotation Log

| Time | Area | Task |
|------|------|------|
| 08:00 | 🐕 Tidy Tails | Commercial leads + ads |
| 09:04 | 🐕 Tidy Tails | FB Groups guide |
| 10:00 | 🐕 Tidy Tails | Commercial outreach scripts |
| 11:00 | 🐕 Tidy Tails | Ad library (10 ads) |
| 11:10 | 🐕 Tidy Tails | GMB setup guide |
| 12:00 | 🐕 Tidy Tails | Referral program |
| 12:37 | ⚙️ Systems | Nas copywriter skill |
| 01:00 | 🐕 Tidy Tails | Competitor analysis |
| 02:00 | 🐕 Tidy Tails | Landing page |
...
| 11:00 AM | 🎬 Content | **Craigslist Domination Guide (5 ready templates, anti-flag rules, posting schedule, renewal strategy, untapped FREE channel)** |
| 10:00 AM | 🐕 Tidy Tails | **Nextdoor Complete Playbook (untapped warm lead channel, business page setup, recommendation strategy, posting templates, response scripts)** |
| 09:05 AM | 🏠 Sheds | **No Sale? No Problem (pocket closer, phone-friendly objection handler, payment cheat sheet, helps TJ close TODAY)** |
| 08:00 AM | ⚙️ Systems | **Today's 3 Actions (morning execution guide, 10min zero-decision checklist, forces action over planning)** |
