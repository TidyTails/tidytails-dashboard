...
### Saturday 11:04 AM — Blog Post #94: Dog Poop and Rats — Rodent Pest Series (Hourly Task)
- **11:04 AM** 🐀 Wrote and published **"Dog Poop and Rats in Your Yard — The Connection Nobody Wants to Talk About"** — the first dedicated rodent-pest post in the entire Tidy Tails library, completing the yard pest series with the one predator that connects every other pest in the series
  - **File:** `tidy-tails/website/blog/dog-poop-rats-rodents-yard-st-louis.html` — 49.7KB ✅
  - **Live URL:** `https://tidytailsstl.com/blog/dog-poop-rats-rodents-yard-st-louis` ✅ HTTP 200 confirmed
  - **Git commits:** tidytails-dashboard main `50758dd1` ✅ · tidytails-website master `a65078c` ✅ → Cloudflare Pages live ✅
  - **Blog count: 94 posts total** ✅
  - **Why this task:** 93 posts live, Easter Saturday 11 AM. The pest series (flies ✅ mosquitoes ✅ ticks ✅ worms ✅ fleas ✅) covered every arthropod pest connected to dog waste — but the one pest that DELIVERS all of those pests into the yard (via their wildlife hosts) was completely missing: rodents. "Does dog poop attract rats" is a nationally high-volume query (2K-5K/month). Zero STL competitor has this angle. The connection is real and mechanistic: dog waste is a direct food source for Norway rats and deer mice → rats carry leptospirosis and tick species → same ticks that carry Lyme/ehrlichiosis the ticks post covers. This post is the hub that ties the entire pest series together from a wildlife vector perspective.
  - **Target keywords:** "dog poop attracts rats", "does dog poop attract rats", "dog waste rodents yard", "rats in yard dogs", "dog poop mice yard", "does dog poop attract mice", "rodent control dog waste St. Louis"
  - **Why this audience converts at high rates:** Someone who Googles "does dog poop attract rats" either (a) saw a rat and wants to know if the dog waste is causing it — high urgency, ready to act, or (b) is considering whether to start cleanup and this is the tipping point question. Both profiles are at maximum conversion readiness. "I saw a rat in my yard" + "my dog uses that same yard" = immediate booking.
  - **What's in the post (49.7KB):**
    - **Hero:** "Dog Poop and Rats in Your Yard — The Connection Nobody Wants to Talk About" — dark brown gradient (#0f0a00 → #3d1c02 → #6b2d0a)
    - **Urgency banner:** "Spring rat activity peaks April–May in St. Louis as rodents emerge from winter territories — yard accumulation from winter is the food source that keeps them coming back. First cleanup FREE →"
    - **Stats row:** 48 hrs (rat discovery window) / 300+ deposits/dog/year / April (peak rodent emergence) / $70/mo
    - **5-step chain of events:** Waste emits scent → rat detects food within 24–72 hrs → reliable source → rat establishes territory → territory → reproduction (6–12 pups per litter, 5–7 litters/year)
    - **Big stat callout:** 6–12 rat pups per litter — with 5–7 litters per year when food is consistently available
    - **4 rodent species cards:** Norway Rat (HIGH), Deer Mouse (HIGH — hantavirus + Lyme reservoir), House Mouse (MODERATE), Vole (MODERATE — tick host)
    - **St. Louis Winter Problem section:** 100+ winter deposits thaw simultaneously in April, coinciding with hungry rats expanding winter territories — two factors converging at the worst possible moment
    - **Seasonal calendar:** Winter (accumulation builds) / April CRITICAL (thaw + rat emergence) / May–Sept (active foraging, leptospirosis risk peaks) / Oct–Nov (rats establish winter territories near food sources)
    - **Disease grid (4 cards):** Leptospirosis (HIGH — transmitted via rat urine, risk to dogs and people, MVMA recommends vaccination), Tick-Borne Diseases (HIGH — rats carry Lyme/ehrlichiosis ticks), Hantavirus (HIGH — deer mouse, inhaled via droppings), Salmonella & E. coli (MODERATE)
    - **Leptospirosis dog callout:** MVMA recommends leptospirosis vaccination for dogs with outdoor access in STL metro — but vaccination + food source removal is better than vaccination alone
    - **5 signs of rat activity:** Burrow holes near fence lines, droppings near waste areas, dog obsessed with a fence corner, movement at dusk/dawn, gnaw marks and worn paths
    - **Two-scenario grid:** ❌ Winter accumulation yard (100 deposits thaw → rats find food → burrow established → leptospirosis contamination → ticks introduced → reproduction → pest control call at $300–800) vs ✅ Weekly pickup (no food signal → rats find no reliable source → establish territory elsewhere → no leptospirosis risk → fewer tick introduction events)
    - **What doesn't work alone:** Bait stations without food removal, patchy infrequent cleanup, entry point sealing only
    - **5-step integrated protocol:** Remove winter backlog → weekly pickup (48-hr rule) → eliminate other food sources → reduce yard cover → add bait stations if already established
    - **Pricing strip + 22-city service area + 7-question FAQ with FAQPage schema**
    - **6 related article cards** linking to ticks, flies, fleas, parasites, spring guide, health risks
  - **Cross-links added:**
    - `blog/dog-poop-ticks-yard-st-louis.html`: Added "🐀 Dog Poop and Rats" as FIRST Related Article ✅ (rodents → ticks is the most direct connection)
    - `blog/dog-poop-fleas-yard-st-louis.html`: Added "🐀 Dog Poop and Rats" as FIRST Related Article ✅ (rodents carry fleas into yards)
    - `blog/index.html`: Added as #1 card (dark brown #7c2d12 border/glow, "Rodent Control" tag, April 4 date) ✅ + JSON-LD blogPost entry ✅
    - `sitemap.xml`: Added new URL (priority 0.85, yearly changefreq) ✅
